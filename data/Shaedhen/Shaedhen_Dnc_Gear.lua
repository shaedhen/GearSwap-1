...
function user_job_setup()
	...
	state.Weapons:options('None','Aeneas','AeneasAcc','Tauret','TauretTaming','LowBuff','Shield','DualAE','Setan')
...
function init_gear_sets()
	...
	sets.weapons.Setan 		= {main="Setan Kober"	,sub="Gleti's Knife"}
    -- Precast Sets
